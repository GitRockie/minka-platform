...
@Component({
    selector: 'app-my-navbar-home',
    standalone: true,
    imports: [RouterLinkActive, RouterLink, NgIf, RouterOutlet, NgFor, NgClass, NgbCollapse, NgbDropdownMenu, NgbDropdownItem, NgbDropdown, NgbDropdownToggle, FormsModule ],
